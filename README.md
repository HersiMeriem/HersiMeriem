...
## 🚀 **About Me**  
As a passionate **Full-Stack Developer** and a **Business Intelligence Student**, I specialize in designing and developing **modern, scalable, and high-performance web applications**. My goal is to build seamless digital experiences that enhance productivity and user engagement.  

**💡 What I’m exploring now:**  
- 🎯 Crafting intuitive & dynamic UIs with **Angular** & **Flutter**  
- 🔍 Uncovering insights from data with **Python** & **SQL**  
- ☁️ Expanding knowledge in cloud computing (**Firebase, AWS**)  
