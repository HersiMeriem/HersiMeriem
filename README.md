...
[![Blog](https://img.shields.io/badge/✍️_Blog-FF5722?logo=medium)](
[https://your-blog-link.com](https://portfolio-hersi-meriem.netlify.app))  
...
- ☕ Experimenting with **JavaServer Pages (JSP)**  
...
**Angular | Firebase**  
A simple task management system with real-time updates.  

### 2. [Eco-Tourism Portal](https://github.com/HersiMeriem/wearegabes)  
**Flutter | Figma**  
A local tourism platform promoting Gabès’ cultural heritage.  

### 3. [Inventory Tracker](https://github.com/HersiMeriem/smartstock)  
**Python | SQL**  
A basic inventory management system with data visualization.  
